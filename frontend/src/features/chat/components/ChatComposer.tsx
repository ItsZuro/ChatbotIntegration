...
export function ChatComposer({
  ...
  const canSubmit = message.trim().length > 0 && !loading && !voiceBusy;
      ...
      {isRecording ? (
        <Box px="sm" py="md">
          <Group wrap="nowrap" gap="md">
              ...
              {waveform.map((level, index) => (
                <Box
                  ...
                  style={{
                    ...
                    height: Math.max(4, Math.round(level * 38)),
            ...
            <Tooltip label="Cancelar grabación">
              <ActionIcon
                variant="subtle"
                color="red"
                radius="xl"
          ...
          {liveTranscript ? (
            <Text size="sm" ta="center" mt="sm" lineClamp={2}>
              {liveTranscript}
            </Text>
          ) : (
          ...
          <Text size="xs" c="dimmed" ta="center" mt={4}>
            Habla con normalidad. Detén la grabación para finalizar.
          </Text>
        </Box>
      ) : isTranscribing ? (
        <Group justify="center" gap="xs" px="sm" py="lg">
